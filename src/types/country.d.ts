...
type BaseCountryData = [string, CountryIso2, string];

type FormatConfig = Record<string, string> & {
  default: string;
};

type CountryDataWithFormat = [...BaseCountryData, FormatConfig | string];

type CountryDataWithOrder = [...CountryDataWithFormat, number];

type CountryDataAreaCodes = [...CountryDataWithOrder, string[]];
