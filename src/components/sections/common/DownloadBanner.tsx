...
import img1 from "@/assets/bg/vector-1.png";
import img2 from "@/assets/bg/vector-2.png";

interface DownloadBannerProps {
  docLink?: string;
}

export default function DownloadBanner({ docLink }: DownloadBannerProps) {
  return (
    <section>
      <div className="container max-md:px-0">
        <div className="bg-primary-gradient md:mx-7 relative pt-24 pb-32">
          <Image src={img1} alt="vector" className="absolute left-0 bottom-0" />
