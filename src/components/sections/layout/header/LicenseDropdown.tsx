  ...
  return (
    <li className="relative xl:py-8 group cursor-pointer">
      <div className="max-xl:hidden">
        <span className="flex justify-between gap-x-2 items-center px-4 py-4 xl:py-2 text-xl md:text-base font-bold text-dark group-hover:text-primary hover:bg-gray-100/10 ease-linear duration-300 ">
          Licences
          <svg
            ...
            {licenses.map((license) => (
              <li
                ...
                className={cn(
                  ...
                  pathname === `/licenses/${license?.slug}` && "bg-gray-100/10 "
                )}
              >
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === `/licenses/${license?.slug}` && "text-primary "
                  )}
                >
                  {license?.title}
                </Link>
      ...
      <Collapsible className="xl:hidden">
        <CollapsibleTrigger className="flex justify-between gap-x-2 items-center px-4 py-4 xl:py-2 text-xl md:text-base font-bold text-dark group-hover:text-primary hover:bg-gray-100/10 ease-linear duration-300  w-full [&[data-state=open]>svg]:rotate-180">
          Licences
          <svg
